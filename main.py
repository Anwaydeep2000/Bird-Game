...
while True:
    ...
    pygame.draw.rect(display,pole_color,(pole_x,top_pole_height+pole_ga,pole_width,568))

    #collision
    if pole_x <= bird_x +50 and bird_x <= pole_x + pole_width:
        if bird_y <= top_pole_height or bird_y >= top_pole_height + pole_ga:
            score =score - 1
